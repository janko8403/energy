...
use App\Models\{Configuration, Pv, MeasurementFifteenMinute};
use App\Classes\GetDataApi;

class MeasurementFifteenMinuteCron extends Command
{
     ...
     * @var string
     */
    protected $signature = 'measurement_2:cron';
    ...
    public function handle()
    {
        ...
        foreach ($configurations as $value) {
            ...
            if($value->id != 99) {
                ...
                try {
                    MeasurementFifteenMinute::query()->create(
                        [
