...
use App\Models\{Configuration, Pv, MeasurementOneHour};
use App\Classes\GetDataApi;

class MeasurementOneHourCron extends Command
{
     ...
     * @var string
     */
    protected $signature = 'measurement_3:cron';
    ...
    public function handle()
    {
        ...
        foreach ($configurations as $value) {
            ...
            if($value->id != 99) {
                ...
                try {
                    MeasurementOneHour::query()->create(
                        [
