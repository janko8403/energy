...
if(isset($_GET['deviceAddress'])) {
   ...
   $deviceAddress = 'http://91.232.48.210';
}
// getDataFromDeviceGET(0, $deviceAddress);
function getDataFromDeviceGETDEV($clientId, $deviceAddress) {
...
function getDataFromDevice($clientId, $url, $token) {
